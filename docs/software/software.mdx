...
### 2. Configure your camera
  Insert the Camera IP address, COM (serial) port, or UVC (usb webcam) camera ID in the address slot and click save and restart tracking. You can use [USBTreeView](https://www.uwe-sieber.de/usbtreeview_e.html) to help find the camera address to input.
