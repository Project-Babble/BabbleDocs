---
title: Running the Legacy Desktop App
sidebar_position: 3
---
...
:::warning
This page concerns the legacy Desktop App, which is no longer updated. For current babbling, please use the current Desktop App [Baballonia](docs/software/baballonia/baballonia.mdx).
:::
...
## 2) Downloading The Babble App

Navigate to a folder where you would like to install the Babble App. We'll be using the folder `BabbleApp`.
