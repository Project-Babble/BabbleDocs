...
:::tip
The best way to calibrate is to open up the game of your choice and tweak values while INGAME to see how it looks on your avatar! It is also a good idea to have the debug menu from you face tracking asset open to see the values live.
