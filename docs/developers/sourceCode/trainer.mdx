...
You can do this by running the *last line* in [Step 3](#3-setting-up) in tandem with the command from [Step 4](#4-running-the-babble-trainer), making sure your terminal window is in the same location as it was before.
