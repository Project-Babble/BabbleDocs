...
:::warning
**Linux Users:** Babble Boards do not support UVC/Serial wired, you **must** use a wireless configuration.
:::

:::warning
**Linux Users:** We only support the Steam and GitHub releases, not the AUR package.
:::
