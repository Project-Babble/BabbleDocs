...
![The Vive facial tracker worn on a Vive pro eye headset](\img\htc-vive-facial-tracker-being-worn.webp)
  ...
  - For people who want to hop into [VRChat](docs\intro\integrations\vrc.mdx), [Resonite](docs\intro\integrations\resonite.mdx), or [something else, click here](docs\intro\integrations\integrations.mdx)
  - For [developers, click here](docs\intro\developers\developers.mdx)