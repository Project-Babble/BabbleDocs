...
Ultimately, I determined there wasn't anything out there with the features I was looking for. I wanted a version of the current desktop app to run on Linux, staying true to the original as possible. With some quality-of-life improvements such as the ability to search for modules, custom themes, and so on.
