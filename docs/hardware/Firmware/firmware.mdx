...
<img src={require("@site/static/img/firmware/Start.png").default}/>
...
<details>
  ...
  <div style={{
    ...
    <img src={require("@site/static/img/firmware/WifiConfig.png").default}/>
...
<img src={require("@site/static/img/firmware/Download.png").default}/>
...
<img src={require("@site/static/img/firmware/WROOM.jpg").default}/>
...
<img src={require("@site/static/img/firmware/Upload.png").default}/>
...
<img src={require("@site/static/img/firmware/ETVR_1.png").default}/>

If prompted for wifi, just enter anything to move on. You don't need to deal with this either.

<img src={require("@site/static/img/firmware/ETVR_2.png").default}/>
...
<img src={require("@site/static/img/firmware/ESP32.png").default}/>
