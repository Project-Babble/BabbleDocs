...
![CallibrationTabLocation](/img/CalibrationGuideImages/CalibrationTab.png)
...
![BlendshapesDropdownMenus](/img/CalibrationGuideImages/BlendshapesMenus.png)
...
![SlidersExample](/img/CalibrationGuideImages/BlankSlider.png)

The slider also contains a red dot visualizing the current state of the given blendshapes that is being detected.

![SliderRedDot](/img/CalibrationGuideImages/RedDotSlider.png)
...
![SliderLeftSide](/img/CalibrationGuideImages/LeftSideSlider.png)
...
![SliderRightSide](/img/CalibrationGuideImages/RightSideSlider.png)
...
![SliderMinimumAdjustment](/img/CalibrationGuideImages/ExampleSlider.png)
...
![FTDebugPicture](/img/CalibrationGuideImages/FTDebug.png)
:::
