---
id: diyfirm
title: DIY Tracker Firmware
sidebar_position: 1
pagination_next: software/baballonia/baballonia
---

:::info
If you purchased a Babble PCB (by itself, as part of the Base Kit, or the Supporter Kit) you do _NOT_ need to follow the directions below.

This guide is only for users who have _sourced seperate hardware_, which isn't supported by Baballonia's built in firmware installer.
:::
...
Before moving onto the next steps, you'll need to put your device in _Boot Mode_ to write firmware to it. To do this, hold down the boot mode button on your board **as you plug it in.** You'll feel a _click_ as the button presses in and out. On the `Babble V1` board, the button is pictured here:
