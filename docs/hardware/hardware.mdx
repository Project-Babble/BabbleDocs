...
<details>
  <summary>Camera Compatibility Table</summary>
    ...
    For a more comprehensive breakdown, please visit the [cameras page.](hardware\components\cameras.mdx)
...
Now that you have set up hardware, we can move onto the [software side of things!](docs\software\software.mdx)
