...
Currently, the Project Babble team uses a synthetic data training pipeline to train our eye and face models. While these are effective, the introduction of real human eye/face data _dramatically_ improves model fidelity.
