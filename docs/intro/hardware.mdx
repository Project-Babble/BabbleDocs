...
Project Babble hardware agnostic, it has been designed to be used on a variety of devices without issue. The following table outlines cameras have been tested:
...
Now that you have set up hardware, we can move onto the Software side of things!