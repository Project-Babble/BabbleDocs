...
This guide applies to the Official Babble Tracker (and DIY versions with similar hardware/firmware) **with the Legacy App**. The first half of instructions here are the same as Baballonia.
