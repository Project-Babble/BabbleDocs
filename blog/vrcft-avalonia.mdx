...
I have been using VRCFaceTracking for quite some time now. At the time of writing this, the better part of 2/3 years.
...
During this time, I have also seen the growth of VR on Linux. I understand the majority of people who use VR (and by extension, users of social VR apps) use Windows, myself included. I'm writing this on a my 11-year old workstation I built back in 2014, and it's seen every version of Windows 10 since.
...
Before getting my hands dirty, I looked around to see if anyone had done any relevant work prior to me. I was able to find a project called OSCAVGMGR, but I guess I didn't vibe with it.
...
Shoutout to MamaMiaDev for creating an amazing video series on YouTube. They helped me understand Avalonia when things got confusing, and their code serves as the solid foundation for this project.
...
This next portion iof this story a little detour. I promise it's reelavt :).

On the second night of me testing this, a friend of mine joined on me in VRChat in Desktop mode, eager to show me something he was working on. 

It turns out he had riced a fresh install of Arch Linux to look just like Windows 7. Very nice. It was a solid job, I've only seen Win7 themes for cinammon but nothing for KDE.
...
Ok, his eyes were a little wonky but I suspect this might due to a faulty software update Meta pushed.

We opted to use the ALXR module instead with a nightly build of ALXR, and the issue vanished. Here's Bread!
...
Up next, I want to create installers for Windows, macOS and Linux. I've started work on using `pup-net`, a tool that builds and creates installers with one script.

I could also take the Babble App approach that curls down a bash script, and runs that and adds `vrcft` as a path-invokable terminal command.

I'm also looking other tools, such as ___.
...
VRCFaceTracking has been translated into 5, and it doesn't come bundled with a language selector. To this end, I've created a Crowdin page for this, and translations here are directly applicable to both our app as well as the base app.
...
If you want to check out the code for this project we have it here! We also have downloads there as well, feel free to snag a copy. That does it for me here. I'll keep y'all posted:
