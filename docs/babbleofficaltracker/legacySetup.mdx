...
- The feed may appear choppy in this mode - _this is normal_
...
Want to use your tracker wirelessly? Check out our [Firmware Guide](docs\diytrackers\partsguide\partsguide.mdx) for instructions on enabling and configuring WiFi functionality.
