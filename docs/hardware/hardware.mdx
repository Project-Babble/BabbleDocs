...
Here is a good reference photo to follow. If you have used the HTC Vive Facial tracker, then the position should be somewhat the same.

![The Vive facial tracker worn on a Vive pro eye headset](\img\htc-vive-facial-tracker-being-worn.webp)

Now that you have set up hardware, we can move onto the [software side of things!](<docs\Developers\Software Developers\developersSE.mdx>)
