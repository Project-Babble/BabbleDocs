...
sidebar_position: 4
title: Firmware
pagination_next: software/baballonia/baballonia
---
...
Before you can use your Babble Tracker, you will need to configure it into mode.

### Step 1 - Open Baballonia and navigate to the Firmware page:

### Step 1.1 - Plug in _or_ unplug and replug your tracker to make sure it's in configuration mode.
...
:::info
The tracker will now boot into either Wired or Wireless mode. If in wired mode it will function as a USB camera with the device name 'openiristracker', if it's in wireless mode it will host a camera stream on the URL 'http://openiristracker.local/'
:::
